...
hl.monitor({ output = "", mode = "preferred", position = "auto", scale = 1, mirror = desktopDisplay })                  -- automatically mirror new random monitors in their preferred resolution
...
hl.monitor({ output = "", mode = "4096x2160@60.00", position = "auto", scale = 1, mirror = laptopDisplay })             -- automatically mirror new random monitors in their preferred resolution
